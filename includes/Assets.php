...
abstract class Assets {
	...
	public static function get_styles() {
		...
		return apply_filters( 'saucal_hub_enqueue_styles', array() );
	}
	...
	public static function get_scripts() {
		...
		return apply_filters( 'saucal_hub_enqueue_scripts', array() );
	}
	...
	public static function load_scripts() {
		...
		if ( ! did_action( 'before_saucal_hub_init' ) ) {
			return;
		}
	...
	private static function localize_script( $handle ) {
		...
		if ( ! in_array( $handle, self::$wp_localize_scripts, true ) && wp_script_is( $handle ) ) {
			...
			if ( $data ) {
				...
				wp_localize_script( $handle, $name, apply_filters( 'saucal_hub_script_data_' . $name, $data ) );
			}
		}
	}
